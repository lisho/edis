...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['equipo_id'], 'references' => ['equipos', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2016-07-10 00:08:04',
            'modified' => '2016-07-10 00:08:04',
            'equipo_id' => 1
        ],
    ];
}
