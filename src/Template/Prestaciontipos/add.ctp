...
<h1><i class="fa fa-pencil-square-o"></i>  Gestión de Tipos de Prestaciones.</h1>
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Crea un Tipo de Prestación</h2>
            ...
            <div class="x_content">    
                ...
                <fieldset>
                    ...
                    <div class="form-group has-feedback">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Tipo de Prestación <span class="required">*</span></label>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Listado de los posibles Tipos de Prestación</h2>
                <?= $this->Element('menus/menu_panel');?>                
                <div class="clearfix"></div>
            </div>
            <div class="x_content">    
                <table id="datatable" class="table table-striped table-bordered" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        <?php foreach ($tipos_de_prestacion as $tipo): ?>
                        <tr>
                            <td><?= h($tipo->id) ?></td>
                            <td><?= h($tipo->tipo) ?></td>
                            ...
                            <td class="actions">
                             ...
                             <?php if ($auth['role'] === 'admin'): ?>    
                                <?= $this->Form->postLink('', ['action' => 'delete', $tipo->id], ['class'=> 'btn btn-xs btn-danger fa fa-trash', 'confirm' => __('¿Realmente quieres borrar este tipo de prestación?')]) ?>
                            <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
