...
<div class="col-md-12 col-sm-12 col-xs-12"> 
    <div class="x_panel"> 
        <div class="x_title"> 
            <h2><i class="icono-titulo-fa fa fa-folder-open"></i>Expediente: <big><?= h($expediente->numedis) ?> </big></h2> 
            <ul class="nav navbar-right panel_toolbox"> 
              <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a> 
              </li> 
              <li class="dropdown"> 
...
<!--Participantes-->
            <div class="related"> 
                <h4><i class="icono-fa fa fa-group"></i><?= '  Parrilla Familiar de este expediente:' ?></h4> 
                <?php if (!empty($expediente->participantes)): ?> 
                <table id="datatable" class="table table-striped table-bordered" cellpadding="0" cellspacing="0"> 
                    <tr> 
                        <th><?= __('Id') ?></th>
